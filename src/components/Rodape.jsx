  ...
  return (
    <footer>
      <Container fluid className="text-center bg-dark py-3">
        <small className="text-secondary">&copy; 2024. Desenvolvido por <a href="https://github.com/flaviare1s" target="_blank" className="text-secondary text-decoration-none fw-bold">Flávia Reis</a>.</small>
